...
public final class DataUtils {
	...
	// some Suppliers
	public static final Supplier<String> RAND_STRING_SUPPL = () -> RandomStringUtils.randomAlphabetic(15);

	public static final IntSupplier RAND_AGE_SUPPL = () -> RandomUtils.nextInt(20, 50);

	public static final Supplier<Gender> RAND_GENDER_SUPPL = () -> Gender.values()[RandomUtils.nextInt(0, Gender.values().length)];

	public static final IntSupplier RAND_GRADE_SUPPL = () -> RandomUtils.nextInt(0, 10);

	public static final Supplier<DegreeField> RAND_DEGREE_FIELD_SUPPL = () -> DegreeField.values()[RandomUtils.nextInt(0, DegreeField.values().length)];

	public static final Supplier<JobCategory> RAND_JOB_CAT_SUPPL = () -> JobCategory
			.values()[RandomUtils.nextInt(0, JobCategory.values().length)];

	private DataUtils() {
	}

	public static Candidate buildCandidate(Supplier<String> strSuppl, IntSupplier ageSuppl, Supplier<Gender> genderSuppl) {
	...
	public static Candidate buildCandidate() {
		return buildCandidate(RAND_STRING_SUPPL, RAND_AGE_SUPPL, RAND_GENDER_SUPPL);
	}

	public static List<Candidate> buildCandidates(Supplier<String> strSuppl, IntSupplier ageSuppl,
			Supplier<Gender> genderSuppl, int numberOfCandidates) {
		return IntStream
	...
	public static List<Candidate> buildCandidates(int numberOfCandidates) {
		return buildCandidates(RAND_STRING_SUPPL, RAND_AGE_SUPPL, RAND_GENDER_SUPPL, numberOfCandidates);
	}
